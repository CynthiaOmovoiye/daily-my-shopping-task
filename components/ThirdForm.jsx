        ...
        <div className='p-4 rounded-lg bg-white'>
            ...
            <form>
                ...
                <div className="mt-6  w-full">
                    <button type="submit" className="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600 w-full">Save</button>
                </div>
            </form>
